...
- многоразмерная `.ico`-иконка из нового логотипа NexRoute;
...
- все 22 BAT-конфигурации получают расширенные Service Matrix TCP/UDP-фильтры;
- Strategy Lab динамически читает включённые сервисы;
