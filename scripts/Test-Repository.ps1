...
$required=@(
    ...
    'tests/StrategyRanking064.Tests.ps1','tests/StrategyLab065.Tests.ps1','tests/Updater065.Tests.ps1','tests/UpdaterHealthRollback064.Tests.ps1','tests/GitHubActionsPinning064.Tests.ps1',
